...
BEGIN SCHEMATIC
    ...
    BEGIN NETLIST
        ...
        BEGIN BLOCK XLXI_41 ir_decoder
            ...
            PIN inc_dac2 loaddac2
            PIN tx tx
            PIN uart_ready
            PIN read
            PIN restest restest
            PIN doutrdy doutrdy
            PIN address(5:0) count_sel(5:0)
        ...
        BEGIN BLOCK XLXI_40 top_drom
            ...
            PIN sel_status
            PIN sel_vers(8:0) sel_ver(8:0)
            PIN sel_counters(31:0) sel_counts(31:0)
            PIN sel_pencoder sel_pencoder
        END BLOCK
        BEGIN BLOCK XLXI_14 ibuf8
            PIN I(7:0) stop_pulses(7:0)
            PIN O(7:0) stop_pulses_buf(7:0)
        END BLOCK
    ...
    BEGIN SHEET 1 3520 2720
        ...
        BEGIN BRANCH loaddac2
            WIRE 1904 2016 1968 2016
            WIRE 1968 2016 2208 2016
            BEGIN DISPLAY 1968 2016 ATTR Name
                ALIGNMENT SOFT-BCENTER
            END DISPLAY
        END BRANCH
        ...
        IOMARKER 2208 2016 loaddac2 R0 28
        ...
        BEGIN BRANCH sel_pencoder
            ...
            END DISPLAY
        END BRANCH
        BEGIN BRANCH sel_counts(31:0)
            WIRE 2976 2192 3104 2192
        END BRANCH
        BEGIN BRANCH sel_dac2
            WIRE 2976 2000 3232 2000
        END BRANCH
        ...
        END INSTANCE
        IOMARKER 3232 2000 sel_dac2 R0 28
        IOMARKER 3232 1936 sel_dac1 R0 28
        IOMARKER 3200 1872 sel_fpga R0 28
        IOMARKER 3104 2192 sel_counts(31:0) R0 28
        IOMARKER 3184 2256 sel_pencoder R0 28
        IOMARKER 3104 2128 sel_ver(8:0) R0 28
        BEGIN BRANCH start_pulse
            WIRE 1136 912 1232 912
        END BRANCH
        BEGIN BRANCH stop_pulses(7:0)
            WIRE 1200 1424 1280 1424
        END BRANCH
        INSTANCE XLXI_14 1280 1456 R0
        BEGIN BRANCH stop_pulses_buf(7:0)
            WIRE 1504 1424 1808 1424
        END BRANCH
        IOMARKER 1200 1424 stop_pulses(7:0) R180 28
        IOMARKER 1280 2272 fpgasel(2:0) R180 28
        IOMARKER 1808 1424 stop_pulses_buf(7:0) R0 28
