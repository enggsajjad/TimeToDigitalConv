...
BEGIN SCHEMATIC
    ...
    BEGIN SHEET 1 9600 3200
        ...
        END BRANCH
        IOMARKER 9104 2400 "Qout(15:0)" R0 28
        ...
        BUSTAP 5056 2016 5056 1920
        BUSTAP 5536 2016 5536 1920
        BUSTAP 6016 2016 6016 1920
        BUSTAP 6496 2016 6496 1920
        BUSTAP 6976 2032 6976 1936
        BUSTAP 7456 2016 7456 1920
        BUSTAP 7936 2016 7936 1920
        BUSTAP 8384 2016 8384 1920
        BEGIN BRANCH "Qout(0)"
        ...
        END BRANCH
        BEGIN BRANCH "Qout(8)"
            WIRE 5056 1680 5056 1920
        END BRANCH
        BEGIN BRANCH "Qout(9)"
            WIRE 5536 1680 5536 1920
        END BRANCH
        BEGIN BRANCH "Qout(10)"
            WIRE 6016 1680 6016 1920
        END BRANCH
        BEGIN BRANCH "Qout(11)"
            WIRE 6496 1680 6496 1920
        END BRANCH
        BEGIN BRANCH "Qout(12)"
            WIRE 6976 1680 6976 1936
        END BRANCH
        BEGIN BRANCH "Qout(13)"
            WIRE 7456 1696 7456 1920
        END BRANCH
        BEGIN BRANCH "Qout(14)"
            WIRE 7936 1680 7936 1920
        END BRANCH
        BEGIN BRANCH "Qout(15)"
            WIRE 8384 1680 8384 1920
        END BRANCH
        ...
        BUSTAP 5056 960 5056 1056
        BUSTAP 5536 960 5536 1056
        BUSTAP 6016 960 6016 1056
        BUSTAP 6480 960 6480 1056
        BUSTAP 6960 960 6960 1056
        BUSTAP 7456 960 7456 1056
        BUSTAP 7936 960 7936 1056
        BUSTAP 8368 960 8368 1056
        BEGIN BRANCH "Din(15:0)"
            WIRE 640 656 1216 656
        ...
        END BRANCH
        BEGIN BRANCH "Din(8)"
            WIRE 5056 1056 5056 1296
        END BRANCH
        BEGIN BRANCH "Din(9)"
            WIRE 5536 1056 5536 1296
        END BRANCH
        BEGIN BRANCH "Din(10)"
            WIRE 6016 1056 6016 1296
        END BRANCH
        BEGIN BRANCH "Din(11)"
            WIRE 6480 1056 6480 1168
            WIRE 6480 1168 6496 1168
            WIRE 6496 1168 6496 1296
        END BRANCH
        BEGIN BRANCH "Din(12)"
            WIRE 6960 1056 6960 1168
            WIRE 6960 1168 6976 1168
            WIRE 6976 1168 6976 1296
        END BRANCH
        BEGIN BRANCH "Din(13)"
            WIRE 7456 1056 7456 1312
        END BRANCH
        BEGIN BRANCH "Din(14)"
            WIRE 7936 1056 7936 1296
        END BRANCH
        BEGIN BRANCH "Din(15)"
            WIRE 8368 1056 8368 1168
            WIRE 8368 1168 8384 1168
            WIRE 8384 1168 8384 1296
        END BRANCH
        ...
        BEGIN INSTANCE "latch_7" 4320 1296 R90
            ...
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_8" 4800 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_9" 5280 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_10" 5760 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_11" 6240 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_12" 6720 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_13" 7200 1312 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_14" 7680 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
            END DISPLAY
        END INSTANCE
        BEGIN INSTANCE "latch_15" 8128 1296 R90
            BEGIN DISPLAY 0 -424 ATTR "RLOC"
                ALIGNMENT VLEFT
                FONT 28 "Arial"
                DISPLAYFORMAT NAMEEQUALSVALUE
        ...
        END BRANCH
        IOMARKER 640 1072 "GE(15:0)" R180 28
        ...
        BUSTAP 4992 1104 4992 1200
        BUSTAP 5472 1104 5472 1200
        BUSTAP 5952 1104 5952 1200
        BUSTAP 6432 1104 6432 1200
        BUSTAP 6912 1104 6912 1200
        BUSTAP 7392 1104 7392 1200
        BUSTAP 7872 1104 7872 1200
        BUSTAP 8320 1104 8320 1200
        BEGIN BRANCH "GE(0)"
        ...
        END BRANCH
        BEGIN BRANCH "GE(8)"
            WIRE 4992 1200 4992 1296
        END BRANCH
        BEGIN BRANCH "GE(9)"
            WIRE 5472 1200 5472 1296
        END BRANCH
        BEGIN BRANCH "GE(10)"
            WIRE 5952 1200 5952 1296
        END BRANCH
        BEGIN BRANCH "GE(11)"
            WIRE 6432 1200 6432 1296
        END BRANCH
        BEGIN BRANCH "GE(12)"
            WIRE 6912 1200 6912 1296
        END BRANCH
        BEGIN BRANCH "GE(13)"
            WIRE 7392 1200 7392 1312
        END BRANCH
        BEGIN BRANCH "GE(14)"
            WIRE 7872 1200 7872 1296
        END BRANCH
        BEGIN BRANCH "GE(15)"
            WIRE 8320 1200 8320 1296
        END BRANCH
        IOMARKER 640 656 "Din(15:0)" R180 28
        IOMARKER 592 1200 "Gbar" R180 28
        IOMARKER 592 1280 "reset" R180 28
    END SHEET
END SCHEMATIC
